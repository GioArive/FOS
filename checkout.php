...
?>
<title>Food Ordering system for Students</title>
				...
				<div class="card-body">
					<div class="container-fluid">
						...
						<div class='row'>
							...
							<div class="col-md-6 lh-1">
								<h3>Order Summary</h3>
								<p class="mb-1"><strong>Items</strong>: PHP <?php echo $orderTotal; ?></p>
								<p class="mb-1"><strong>Delivery</strong>: PHP 0</p>
								<p class="mb-1"><strong>Total</strong>: PHP<?php echo $orderTotal; ?></p>
								<p class="mb-1"><strong>Order Total</strong>: PHP<?php echo $orderTotal; ?></p>
							</div>
						</div>
					</div>
				</div>
