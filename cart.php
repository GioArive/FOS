	...
	<div class="container-fluid">		
		...
		?>      
			...
			?>
				...
				<td class="text-end">PHP <?php echo $values["item_price"]; ?></td>
				<td class="text-end">PHP <?php echo number_format($values["item_quantity"] * $values["item_price"], 2); ?></td>
		...
		?>
			<div class="container">
				...
				<h3 class='text-center'>Your cart is empty. Explore are <a href="./index.php" class="text-decoration-none fw-bolder">Menu</a>.</h3>        
				</div>      
			</div>    
		<?php
		}
